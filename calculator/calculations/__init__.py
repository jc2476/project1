...
from calculator.operations import Addition as Add, Subtraction as Sub
from calculator.operations import Multiplication as Mult, Division as Div
...
class Calculation:
    ...
    def convert_args_to_tuple_of_float(tuple_list):
        ...
        # into a standard data format to keep things consistent so we convert it float
        # then i make it a tuple again because i actually won't need to change calculation values
